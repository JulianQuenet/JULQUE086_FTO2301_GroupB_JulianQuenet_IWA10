...
console.log(
  newXmas.date < holidays[6].date? `New date is earlier: ${true}`: `New date is earlier: ${false}`
);
...
console.log(
  copied[6].id !== holidays[6].id? `ID change: ${copied[6].id}`: `ID change: ${false}`
);
//Check and alert for Name changes?
console.log(copied[6].name !== holidays[6].name? `Name change: ${copied[6].name}`: `Name change: ${false}`
);
//Check and alert for Date changes?
console.log(
  copied[6].date !== holidays[6].date? `Date change: ${copied[6].date}`: `Date change: ${false}`);
